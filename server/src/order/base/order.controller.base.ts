...
export class OrderControllerBase {
  ...
  async findManyCustomerId(
    ...
    const results = await this.service.findCustomerId(params.id, {
      ...query,
      select: {
        createdAt: true,
        customerName: true,
  ...
  @common.Post("/:id/customerId")
  async connectCustomerId(
    @common.Param() params: OrderWhereUniqueInput,
  ...
  @common.Delete("/:id/customerId")
  async disconnectCustomerId(
    @common.Param() params: OrderWhereUniqueInput,
    @common.Body() body: CustomerWhereUniqueInput[]
  ): Promise<void> {
    const data = {
